        ...
        <div className="rounded-2xl bg-white p-8 shadow-2xl">
          ...
          <div className="space-y-5">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-slate-200 bg-white px-4 py-3.5 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 transition-all"
            >
